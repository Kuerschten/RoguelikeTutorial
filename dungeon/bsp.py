...
def generate_dungeon(
    ...
    bsp.split_recursive(
        depth=5,
        min_width=room_max_size + 1,
        min_height=room_max_size + 1,
    ...
    _place_player(player, rooms, dungeon)
